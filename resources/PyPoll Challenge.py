...
# Read CSV file using file path + with open + variable
with open("resources/election_results.csv") as er:
    file1 = csv.reader(er, delimiter = ",")
    next(file1, None)
    election_df = [row for row in file1]

# Create output TXT file using f and open + file path
f = open("resources/analysis/election analysis.txt","w")

# Initialize votes integer, options list, votes per candidate library.
total_votes = 0

# Candidate Options and candidate votes.
candidate_options = ["Charles Casper Stockham", "Diana DeGette", "Raymon Anthony Doane"]
candidate_votes = {85213, 272892, 11606}
